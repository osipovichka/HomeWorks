...
namespace MyDoublyLinkedList.Tests
{
    [TestFixture]
    public class DoublyLinkedListTests
    {
        ...
        public int[] AddFirst2Test(int[] val, int[] arr)
        {
            DoublyLinkedList list = new DoublyLinkedList(arr);
            list.AddFirst(val);
        ...
        [TestCase(7, new int[] { }, ExpectedResult = new int[] { 7 })]
        ...
        public int[] AddLast2Test(int[] val, int[] arr)
        {
            DoublyLinkedList list = new DoublyLinkedList(arr);
            list.AddLast(val);
        ...
        public int[] AddAt2Test(int idx, int[] val, int[] arr)
        {
            DoublyLinkedList list = new DoublyLinkedList(arr);
            list.AddAt(idx, val);
